...
def create_text_list():
    texts_list = []
    texts_list.append(read_text('data/Galdos_Fortunata_y_Jacinta.txt', 'Fortunata y Jacinta'))
    ...
    texts_list.append(read_text('data/Galdos_Marianela.txt', 'Marianela', author='Benito Pérez Galdós'))
    ...
    texts_list.append(read_text('data/Pardo_Bazan_Los_pazos_de_Ulloa.txt', 'Los pazos de Ulloa'))
    ...
    texts_list.append(read_text('data/Valera_Morsamor.txt', 'Morsamor', author='Juan Valera'))
    texts_list.append(read_text('data/Valera_Pasarse_de_listo.txt', 'Pasarse de listo', author='Juan Valera'))
    texts_list.append(read_text('data/Valera_Pepita_Jimenez.txt', 'Pepita Jiménez'))
